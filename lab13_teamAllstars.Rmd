...
The real data summary statistic falls in the `r correlation_percentile`th percentile. With this, and a p value of `r p_value` , I'm concluding that there is not a significant correlation between the annual CO2 emissions per person and the annual coal consumption in the Canada.
